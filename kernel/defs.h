...
void mru_init(void);
void mru_touch(struct proc*, uint64);
void mru_remove(struct proc*, uint64);
void dumpmru_to_console(void);
int ensure_free_page(void);
int handle_cow_fault(struct proc*, uint64);
int handle_pgfault_or_invalid(struct proc*, uint64);
struct proc* find_proc_by_pid(int pid);


int free_pages_available(void);
